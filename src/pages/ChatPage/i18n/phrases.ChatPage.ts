...
const phrases: PhraseSet[] = [
  ...
  {
    key: "alertBoughtPremiumChat",
    text: "Bought premium chat for friends! Check your wallet confirmation in a few minutes.",
  },
  { key: "btnConfirmPurchase", text: "Confirm Purchase" },
  { key: "labelGiftPremiumLong", text: "Gift Premium Chat" },
  {
    key: "infoBuyPremium",
    text: "Buy Premium Chat for your group members. 1 month = 1 cookie",
  },
  ...
  {
    key: "infoOnlyAdminsInvite",
    text: "Only admins can invite their friends to a groupchat",
  },
  ...
  {
    key: "popConfirmResignBody",
    text: "Are you sure you want to resign as admin? You may only leave the chat by resigning first. There must be at least 1 admin.",
  },
  ...
  {
    key: "infoRemoveMember",
    text: "Are you sure you want to remove them from this groupchat?",
  },
  ...
  {
    key: "infoLeaveGroupchat",
    text: "Are you sure you want to leave the groupchat? You can only rejoin if an admin friend re-invites you.",
  },
  ...
  { key: "labelIsNotPNG", text: "is not a png file" },
  { key: "alertUpdatedGroupchatInfo", text: "Updated groupchat info" },
  { key: "alertInvitedFriendAlert", text: "Invited friend to chat" },
  { key: "alertNtoifsEnabled", text: "Notifications enabled" },
  { key: "alertMutedNofifs", text: "Muted notifications" },
  { key: "alertPromotedAdminn", text: "Promoted to admin" },

  { key: "resChatNotFound", text: "Chat not found" },
  {
    key: "resNoPermViewChat",
    text: "You may not have permission to view this chat or it no longer exists.",
  },
  { key: "btnGoBackk", text: "Go Back" },
];
